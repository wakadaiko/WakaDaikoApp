...
namespace WakaDaikoApp.Migrations
{
    ...
    [Migration("20240315045030_Comment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WakaDaikoApp.Models.ShimeAudio", b =>
                {
                    ...
                    b.ToTable("ShimeAudio");
                });

            modelBuilder.Entity("WakaDaikoApp.Models.ShimeText", b =>
                {
            ...
            modelBuilder.Entity("WakaDaikoApp.Models.ShimeVideos", b =>
                {
                    ...
                    b.ToTable("ShimeVideos");
                });

            modelBuilder.Entity("WakaDaikoApp.Models.TaikoAudio", b =>
                {
                    b.Property<int>("AudioId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TaikoAudio");
                });

            modelBuilder.Entity("WakaDaikoApp.Models.TaikoText", b =>
                {
                    b.Property<int>("TextId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WakaDaikoApp.Models.TaikoVideos", b =>
                {
                    b.Property<int>("VideoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WakaDaikoApp.Models.Comment", b =>
                {
                    ...
                    b.HasOne("WakaDaikoApp.Models.ShimeAudio", null)
                        .WithMany("Comments")
                        .HasForeignKey("ConvoId");

                    b.HasOne("WakaDaikoApp.Models.TaikoAudio", null)
                        .WithMany("Comments")
                        .HasForeignKey("ConvoId");
                    ...
                    b.HasOne("WakaDaikoApp.Models.TaikoText", null)
                        .WithMany("Comments")
                        .HasForeignKey("ConvoId");

                    b.HasOne("WakaDaikoApp.Models.ShimeVideos", null)
                        .WithMany("Comments")
                        .HasForeignKey("ConvoId");

                    b.HasOne("WakaDaikoApp.Models.TaikoVideos", null)
                        .WithMany("Comments")
                        .HasForeignKey("ConvoId");
